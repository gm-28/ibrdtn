...
int main() {
    ...
    ssh_session session1 = start_session("localhost", "moreira1", "/home/moreira/.ssh/id_rsa", "2222");
    ssh_session session2 = start_session("localhost", "moreira2", "/home/moreira/.ssh/id_rsa", "2223");
